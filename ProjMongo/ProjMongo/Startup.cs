...
using ProjMongo.Data;
using ProjMongo.Utils;
...
namespace ProjMongo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ProjMongo", Version = "v1" });
            }); 
            ...
            //services.AddDbContext<ProjMongoContext>(options =>
            //        options.UseSqlServer(Configuration.GetConnectionString("ProjMongoContext")));
